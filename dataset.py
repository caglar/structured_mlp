...
class Dataset(object):
    ...
    def setup_dataset(self,
        ...
        if train_split_scale != 0:
            self.Xtrain = self.data[0][:ntrain]
            self.Ytrain = np.array(self.binarize_labels(self.data[1][:ntrain].flatten()) \
            if self.is_binary else self.data[1][:ntrain].flatten())

        if train_split_scale != 1.0:
            self.Xtest = self.data[0][ntrain:]
            self.Ytest = np.array(self.binarize_labels(self.data[1][ntrain:].flatten()) \
            if self.is_binary else self.data[1][ntrain:].flatten())
    ...
    def setup_pretraining_dataset(self,
        ...
        if train_split_scale != 0.0:
            ...
            self.Xtrain_presences = self.data[2][:ntrain]
        ...
        if train_split_scale != 1.0:
            ...
            self.Xtest_presences = self.data[2][ntrain:]
